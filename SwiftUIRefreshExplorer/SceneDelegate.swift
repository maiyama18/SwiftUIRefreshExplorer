...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func createTabBarViewController() -> UITabBarController {
        ...
        let representable = UIViewRepresentableScrollViewController()
        representable.tabBarItem = UITabBarItem(title: "Representable", image: UIImage(systemName: "bolt"), tag: 1)
        ...
        tabBarViewController.viewControllers = [custom, representable, swiftUIPullToRefresh, swiftUIX, swiftUIRefresh]
